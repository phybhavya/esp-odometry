...
void OnDataRecv(const uint8_t *mac_addr, const uint8_t *data, int data_len) {
  ...
  memcpy(&odometry, data, sizeof(odometry));
...
//  coordinate.X = setpoint[0];
//  coordinate.Y = setpoint[1];
